              ...
              <table class="table table-responsive-sm table-bordered" style="width: 100%">
                ...
                <tbody>
                  ...
                  @foreach($bg as $id2 => $arr_acc)
                    <tr>
                      @if($cat_cm == 1 && $id2 == 1)
                        <td colspan="5">1.1 เงินเดือน ค่าจ้าง ค่าตอบแทน</td>
                      @elseif($cat_cm == 1 && $id2 == 2)
                        <td colspan="5">1.2 เงินเดือน ค่าจ้าง ค่าตอบแทนผู้บริหาร</td>
                      @endif
                      @if($cat_cm == 2 && $id2 == 1)
                        <td colspan="5">2.1 ค่าสวัสดิการพนักงาน ลูกจ้าง</td>
                      @elseif($cat_cm == 2 && $id2 == 2)
                        <td colspan="5">2.2 ค่าสวัสดิการผู้บริหาร</td>
                      @endif
                    </tr>
                    @foreach($arr_acc as $acc => $arr_money)
                      @foreach($arr_money as $cent => $value)
                      @php
                        $sum += $value;
                      @endphp
                    <tr>
                      ...
                      <?php
                       ...
                       ?>
                      <td align="center">
                        <input class="form-control" type="text" name="new1[{{$acc}}][{{$cent}}]" value="{{$value}}" @if($able == 'disabled') readonly @endif>
                      </td>
                       <td align="center"><input type="checkbox" name="approve1[]" value="{{$acc.'-'.$cent}}"<?php echo $able; ?>></td>
                      @endif
                      @if(Auth::user()->type == 5)
                      <?php
                        $able = 'disabled';
                       ...
                       ?>
                        <td align="center">
                          <input class="form-control" type="text" name="new2[{{$acc}}][{{$cent}}]" value="{{$value}}" @if($able == 'disabled') readonly @endif>
                        </td>
